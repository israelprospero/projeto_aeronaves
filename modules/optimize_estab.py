...
# Parameters to optimize: xr_w, x_mlg, x_tank_c_w, x_n, x_nlg
def set_params(params):
    airplane['xr_w'], airplane['x_mlg'], airplane['x_tank_c_w'], airplane['x_n'], airplane['x_nlg'] = params
...
def objective(params):
    ...
    targets = np.array([0.1, 0.35, 0.55, 0.45])
    return np.sum((ratios - targets)**2)

x0 = [10.5, 16.0, 0.45, 12.0, 4]
bounds = [
    (10.0, 11.5),   # xr_w
    (12, 17),       # x_mlg
    (0.4, 0.45),    # x_tank_c_w
